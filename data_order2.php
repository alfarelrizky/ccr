...
if(isset($_POST['btnkonf'])){
	...
	# Konfirmasi ke history order	
		$mysqlikon	= "UPDATE order_history SET konfirmasi='$konfirmasi'
					...
					<tr>		
						...
						<td class="text-center">
							<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
								...
								<input type="hidden" name="nama_barang" value="<?php echo $myData['nama_barang']; ?>">								
								<input type="hidden" name="konfirmasi" value="ok">
								<input type="hidden" name="jml_order" value="<?php echo $myData['jumlah_order']; ?>">
								<input type="checkbox" name="users[]" value="<?php echo $myData["id_order_history"]; ?>" class="" checked>
